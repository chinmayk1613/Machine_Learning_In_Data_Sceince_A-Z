# -*- coding: utf-8 -*-
"""
Created on Mon May 18 14:16:57 2020
...
#import dataset
dataset=pd.read_csv('Wine.csv') #load data set
X=dataset.iloc[:,0:13].values    #independnt variables
y=dataset.iloc[:, 13].values     #dependent data
